...
def add_text_to_document(
    ...
    try:
        ...
        if is_heading:
            ...
            # 设置标题的对齐方式
            heading.alignment = alignment_map[alignment]
        else:
        ...
        return f"成功向文档 {os.path.basename(file_path)} 添加了{'标题' if is_heading else '文本'}"
    except Exception as e:
    ...
    try:
        ...
        try:
            ...
            if after_paragraph >= 0 and after_paragraph < doc.Paragraphs.Count:
                doc.Paragraphs(after_paragraph + 1).Range.Select()
            else:
            ...
            # 插入目录
            word.Selection.Fields.Add(Range=word.Selection.Range, Type=-1, Text=f"TOC \\o \"1-{levels}\" \\h", PreserveFormatting=True)
